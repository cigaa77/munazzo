...
import { AccountPlatformService } from './services/account-platform.service';
import { PlatformSettingsService } from './services/platform-settings.service';
import { IntegrationFilterService } from './services/integration-filter.service';
import { ServicesService } from '../../../@core/common-services/services.service';
import { Router, ActivatedRoute } from '@angular/router';
import { Platformsettings } from '../../../@core/data/platform-settings';
import { IntegrationFilter } from '../../../@core/data/integration-filter';
import { AccountPlatform } from '../../../@core/data/account-platform';
import { MyGlobal } from '../../../@core/data/my-global';
import { FormGroup, NgForm } from '@angular/forms';
import { Platform } from '../../../@core/data/platform';
import { FilterCondition } from '../../../@core/data/filter-condition';
import { FilterType } from '../../../@core/data/filter-type';
import { clone } from 'lodash';

@Component({
  selector: 'ngx-account-platform',
